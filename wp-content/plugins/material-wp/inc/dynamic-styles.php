...
/* Add you style here */
  ...
  #screen-meta-links {
    margin-left: <?php echo $this->options->getOption('menu-width'); ?>px;
  ...
  body.rtl #screen-meta-links {
    margin-right: <?php echo $this->options->getOption('menu-width'); ?>px;
    width: <?php echo $percentage; ?>% !important;
  }
...
and (min-width : 1224px) {
  ...
  #mwp-user-card {
    width: <?php echo ($this->options->getOption('menu-width') - 48); ?>px !important;
  }
...
body.toplevel_page_revslider {
  #viewWrapper div.rs-mini-toolbar.sticky {
    top: <?php echo $this->options->getOption('adminbar-height') + 30; ?>px;
  }
}